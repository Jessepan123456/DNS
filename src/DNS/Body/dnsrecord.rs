...
pub enum DnsRecord {
    UNKNOWN {
        ...
        qtype: u16,
        data_len: u16,
        //ttl = time to live, how long it allowed before becomes stale
        ttl: u32,
    },
    A {
        domain: String,
    ...
    MX {
        domain: String,
        //What server to go first before checking on others
        priority: u16,
        host: String,
        ttl: u32,
    }, // 15
...
impl DnsRecord {
    ///Read the individual Dns record by reading the bits
    ...
    ///Write Dns record layout
    /// Name, Type, Class, TTL, record length, record data
